          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						<h3>Data Masukkan Jenis Batik </h3>
						<br/>
						...
						<form method="POST" action="fungsi/tambah/tambah.php?kategori=tambah">
							<table>
								<tr>
									<td style="width:15pc;"><input type="text" class="form-control" required name="kategori" placeholder="Masukan  Jenis Batik Baru"></td>
						...
						<table class="table table-bordered" id="example1">
							<thead>
								<tr style="background:#F08080;color:#333;">
									<th>No.</th>
									<th>Jenis Batik</th>
									<th>Tanggal Input</th>
									<th>Aksi</th>
