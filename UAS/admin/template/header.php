...
<html lang="en">
  <head>
    ...
    <title>Sistem Penjualan Batik NusantaraS </title>
    ...
    <style>
		...
		#main-content{ background:#FFEBCD;}
		#hidden {display:none}
	</style>
  </head>
  <body>
	<section id="container" >
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo" style="font-size:25px;font-family: georgia;"><b><?php echo $toko['nama_toko'];?></b> <small style="padding-left:5px;font-size:13px;font-family: monospace;"><?php echo $toko['alamat_toko'];?></small></a>
            <!--logo end-->
