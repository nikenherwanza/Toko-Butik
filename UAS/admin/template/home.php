<section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-9">
					<div class="row" style="margin-left:1pc;margin-right:1pc;font-family: georgia;">
				  <h1>WELCOME TO BATIK NUSANTARA</h1>
				  <hr>
                      ...
                      <!-- STATUS PANELS -->
                      	<div class="col-md-3">
                      		<div class="panel panel-info">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Batik Terjual</h5>
                      			</div>
                      			<div class="panel-body">
                      	...
                      	<div class="col-md-3">
                      		<div class="panel panel-danger">
                      			<div class="panel-heading">
						  			<h5><i class="fa fa-desktop"></i> Jenis Batik</h5>
                      			</div>
                      			<div class="panel-body">
